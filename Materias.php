                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="materia_insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="clave_materia" placeholder="Clave de la materia" autocomplete = "off" required>
                                    <input type="text" class="form-control mb-3" name="nombre_materia" placeholder="Nombre de la materia" autocomplete = "off" required>
                                    <input type="text" class="form-control mb-3" name="nombre_profesor" placeholder="Nombre del profesor"autocomplete = "off" required>
                                    ...
                                    <input type="text" class="form-control mb-3" name="detalles" placeholder="Detalles" autocomplete = "off" required>
