                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="contacto_insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="nombre_contacto" placeholder="Nombre del Contacto" autocomplete = "off" required>
                                    <p>Seleccione una Etiqueta:</p>
                                    <select name= "etiqueta" class="form-control mb-3">
                                        <option value = "Estudiante">Estudiante</option>
                                        <option value = "Docente">Docente</option>
                                    </select>
                                    <input type="text" class="form-control mb-3" name="telefono_contacto" placeholder="Teléfono" autocomplete = "off" required>
                                    <input type="email" class="form-control mb-3" name="email_contacto" placeholder="Correo" autocomplete = "off" required>
